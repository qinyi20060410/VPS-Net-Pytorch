...
from util.utils import build_targets, to_cpu
...
class YOLOLayer(nn.Module):
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        if targets is None:
            ...
            # print('1:', noobj_mask)
            # print('2:', pred_conf)
            # print('1', pred_conf[noobj_mask])
            # print('2', tconf[noobj_mask])
...
class Darknet(nn.Module):
    ...
    def forward(self, x, targets=None):
        ...
        return yolo_outputs if targets is None else (
            loss, yolo_outputs
        )  # if targets is None  表示  evaluate or test,  否则是  training
